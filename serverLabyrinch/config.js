module.exports = {
  ...
  WELCOME_MESSAGE:
    "You have spawned! Welcome to space! \n" +
    "You will be invulnerable until you move or shoot.\n" +
    "If there are any balancing issues, please let thearraspolice know!",
  ...
  SPAWN_CLASS: ["spaceship", "baseSpaceship"],
  ...
  MAZE_FOOD_CAP: 1, // Max normal food per normal tile.
  MAZE_FOOD_SPAWN_CHANCE: 0.875, // Likeliness of normal food spawn attempts succeeding.
  MAZE_FOOD_SPAWN_COOLDOWN: 20, // Cooldown (in game ticks) of food spawn attempts being made.

  FOOD_CAP_NEST: 1, // Max nest food per nest tile.
  FOOD_SPAWN_CHANCE_NEST: 0.01, // Likeliness of nest food spawn attempts succeeding.
  ...
  BOSS_SPAWN_COOLDOWN: 60000000000,
  ...
  FOOD_TYPES: [
    ...
    [
      ...
      [
        ...
        [125, "shinyTriangle"],
        [35, "shinyPentagon"],
        [15, "shinyBetaPentagon"],
        [11, "shinyAlphaPentagon"],
      ],
    ],
    [
      900,
      [
        ...
        [46, "legendaryPentagon"],
        [16, "legendaryBetaPentagon"],
        [11, "legendaryAlphaPentagon"],
      ],
    ],
    [
      400,
      [
        ...
        [343, "shadowTriangle"],
        [59, "shadowPentagon"],
        [17, "shadowBetaPentagon"],
        [11, "shadowAlphaPentagon"],
      ],
    ],
    [
      600,
      [
        ...
        [74, "rainbowPentagon"],
        [18, "rainbowBetaPentagon"],
        [11, "rainbowAlphaPentagon"],
      ],
    ],
    [
      100,
      [
        ...
        [729, "transTriangle"],
        [91, "transPentagon"],
        [19, "transBetaPentagon"],
        [11, "transAlphaPentagon"],
      ],
    ],
    [
      20,
