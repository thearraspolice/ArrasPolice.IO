...
// Drones
Class.turretedDrone = makeAuto("drone", "Auto-Drone", {
  ...
  GUNS: [
    ...
    },
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "bullet",
          { MOTION_TYPE: ["desmos", { amplitude: 25, invert: true }] },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "bullet",
          { MOTION_TYPE: ["desmos", { period: 7, amplitude: 10 }] },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "bullet",
          {
            MOTION_TYPE: ["desmos", { period: 7, amplitude: 10, invert: true }],
          },
        ],
      },
    },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "splitterBullet",
          { MOTION_TYPE: ["desmos", { invert: false }] },
        ],
      },
    },
    {
...
Class.doubleTwin.UPGRADES_TIER_3 = [
  "tripleTwin",
  "hewnDouble",
  "autoDouble",
  "bentDouble",
...
Class.triAngle.UPGRADES_TIER_3 = [
  "fighter",
  "booster",
  "falcon",
  "bomber",
