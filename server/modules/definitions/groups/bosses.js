  ...
  Class.legionaryCrasherTop.GUNS.push(
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          { speed: 1.3, maxSpeed: 1.3 },
          { speed: 1.3, maxSpeed: 1.3 },
          { size: 0.7, speed: 5, maxSpeed: 2, shudder: 5, range: 1.5 },
        ]),
    ...
    .map((_, i) => ({
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.machineGun,
          g.machineGunner,
          { size: 0.4, spray: 150, speed: 2, shudder: 1.75 },
        ]),
        TYPE: "waferbread",
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
...
eris.addLayer(
  {
    gun: {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "minion",
          { INDEPENDENT: true, COLOR: "pink", HAS_NO_RECOIL: true },
        ],
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
        STAT_CALCULATOR: gunCalcNames.necro,
...
Class.turretedBullet = makeAuto("bullet", "Auto-Bullet", {
  size: 14,
  color: "veryLightGrey",
  angle: 0,
});
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.machineGun,
          g.thruster,
          { range: 0.175, reload: 0.25, recoil: 0.25 },
        ]),
      ...
      .map((_, i) => ({
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.machineGun,
            g.shotgun,
            { spray: 1e6, range: 0.5, shudder: 1.5, damage: 1 + (i % 4) },
          ]),
          TYPE: ["bullet", { PERSISTS_AFTER_DEATH: true }],
          SHOOT_ON_DEATH: true,
        },
...
Class.taureonBoss = {
  ...
  FACING_TYPE: "smoothToTarget",
  UPGRADE_TOOLTIP:
    "With a powerful Gatling Gun on the front, Rocket Launchers as wings, movable Thrusters on the back, " +
      ...
      .map((_, i) => ({
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.basic,
            g.twin,
            { speed: 2, maxSpeed: 2, damage: 0.75, size: 0.8 },
          ]),
          TYPE: "bullet",
        },
      })),
    ...
    },
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          g.sidewinder,
          g.destroyer,
          { shudder: 0.1, reload: 0.6, speed: 5, range: 2 },
        ]),
        TYPE: "taureonMissile",
        STAT_CALCULATOR: gunCalcNames.sustained,
      },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        ...
        SHOOT_SETTINGS: combineStats([
          ...
          g.skimmer,
          g.lowPower,
          { reload: 0.5, recoil: 1.35, speed: 1.3, maxSpeed: 1.3 },
        ]),
...
Class.zephiGearOuter = makeDeco(
  "M 0.5 0.0929 V -0.0908 L 0.3875 -0.1096 C 0.3792 -0.1409 0.3667 -0.1701 0.3521 -0.1952 L 0.4187 -0.2871 L 0.2896 -0.4186 L 0.1958 -0.3539 C 0.1687 -0.3685 0.1396 -0.381 0.1104 -0.3894 L 0.0917 -0.5 H -0.0917 L -0.1104 -0.3873 C -0.1417 -0.3789 -0.1688 -0.3664 -0.1958 -0.3518 L -0.2875 -0.4165 L -0.4188 -0.2871 L -0.3521 -0.1952 C -0.3667 -0.1681 -0.3792 -0.1388 -0.3875 -0.1075 L -0.5 -0.0908 V 0.0929 L -0.3875 0.1117 C -0.3792 0.143 -0.3667 0.1701 -0.3521 0.1973 L -0.4188 0.2912 L -0.2896 0.4207 L -0.1958 0.3539 C -0.1688 0.3685 -0.1396 0.381 -0.1083 0.3894 L -0.0896 0.5 H 0.0938 L 0.1125 0.3873 C 0.1417 0.3789 0.1708 0.3664 0.1979 0.3518 L 0.2917 0.4186 L 0.4208 0.2891 L 0.3542 0.1952 C 0.3688 0.1681 0.3812 0.1409 0.3896 0.1096 L 0.5 0.0929 Z M 0.3333 0 C 0.3333 0.1841 0.1841 0.3333 0 0.3333 C -0.1841 0.3333 -0.3333 0.1841 -0.3333 0 C -0.3333 -0.1841 -0.1841 -0.3333 0 -0.3333 C 0.1841 -0.3333 0.3333 -0.1841 0.3333 0 Z",
  "#7F7F7F",
);
    ...
    .map((_, i) => [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            { speed: 2.5 },
            g.machineGun,
            { spray: 50, speed: 1.25, shudder: 1.25 },
          ]),
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            { speed: 2.5 },
            g.machineGun,
            { spray: 150, speed: 1.25, shudder: 1.25 },
          ]),
          TYPE: ["zephiEggchip", { COLOR: "black" }],
          MAX_CHILDREN: 8,
          AUTOFIRE: true,
        ...
        .map((_, i) => ({
          ...
          PROPERTIES: {
            SHOOT_SETTINGS: combineStats([
              ...
              g.shotgun,
              g.noSpread,
              { recoil: 0, range: 0.4, damage: 2.5, density: 30 },
            ]),
      ...
      .map((_, i) => ({
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.shotgun,
            g.noSpread,
            { recoil: 0, range: 0.4, damage: 2.5, size: 0.5 },
          ]),
          TYPE: ["bullet", { PERSISTS_AFTER_DEATH: true }],
          SHOOT_ON_DEATH: true,
        },
  ...
  ON: [
    {
      ...
      handler: ({ body, gun }) => {
        ...
        setTimeout(
          () =>
            body.sendMessage(
              "Lavender will activate in 10 seconds and turn into S4nctuary F0rM",
            ),
          5000,
        );
      },
...
Class.frostAuraSmall = {
  ...
  BORDERLESS: true,
  SHAPE:
    "M 1 0 L 0.715 0.519 L 0.309 0.951 L -0.273 0.84 L -0.809 0.588 L -0.883 0 L -0.809 -0.588 L -0.273 -0.84 L 0.309 -0.951 L 0.715 -0.519 L 1 0",
  TURRETS: [
    {
...
Class.frostAuraSymbol = {
  ...
  COLOR: "teal",
  SHAPE:
    "M 1 0 L 0.797 0.46 L 0.5 0.866 L 0 0.92 L -0.5 0.866 L -0.797 0.46 L -1 0 L -0.797 -0.46 L -0.5 -0.866 L 0 -0.92 L 0.5 -0.866 L 0.797 -0.46 L 1 0 Z",
  TURRETS: [
    {
      POSITION: [20, 0, 0, 0, 0, 1],
    ...
    GUNS: [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.aura,
            { size: sizeFactor, damage: damageFactor },
          ]),
...
Class.frostAuraBlockTop = {
  SHAPE:
    "M -1.3 -0.15 L -1.3 0.15 L -0.3 0.3 L -0.15 1.3 L 0.15 1.3 L 0.3 0.3 L 1.3 0.15 L 1.3 -0.15 L 0.3 -0.3 L 0.15 -1.3 L -0.15 -1.3 L -0.3 -0.3 Z",
    ...
    .flatMap((_, i) => [
      {
        ...
        PROPERTIES: {
          COLOR: { BASE: -1, BRIGHTNESS_SHIFT: 2.5, SATURATION_SHIFT: 0.9 },
          DRAW_ABOVE: true,
        },
      },
      {
        ...
        PROPERTIES: {
          COLOR: { BASE: -1, BRIGHTNESS_SHIFT: 10, SATURATION_SHIFT: 1.15 },
        },
      },
    ]),
};

const trebuchetStats = [
  g.basic,
  g.sniper,
  g.predator,
  g.predator,
...
const hielamanStats = [
  ...
  g.setTrap,
  g.hexaTrapper,
  { reload: 2.4, health: 3.2, range: 1.2 },
];
Class.frostBoss = {
  PARENT: "miniboss",
  LABEL: "Extrasolar",
  ...
  VALUE: 888888,
  UPGRADE_TOOLTIP:
    "\"When the golden rays of sun shine through this world's\n" +
