...
Class.addons.UPGRADES_TIER_0.push("dreadOfficialV2");
	...
	Class.sword2OfficialV2.UPGRADES_TIER_6 = ["swordOfficialV2"];
	Class.pacifier2OfficialV2.UPGRADES_TIER_6 = ["pacifierOfficialV2"];
	Class.peacekeeper2OfficialV2.UPGRADES_TIER_6 = ["peacekeeperOfficialV2"];
	Class.invader2OfficialV2.UPGRADES_TIER_6 = ["invaderOfficialV2"];
	Class.centaur2OfficialV2.UPGRADES_TIER_6 = ["centaurOfficialV2"];

	Class.dreadWeaponOfficialV2.UPGRADES_TIER_6 = ["swordOfficialV2", "pacifierOfficialV2", "peacekeeperOfficialV2", "invaderOfficialV2", "centaurOfficialV2"];
	...
	Class.dreadBodyOfficialV2.UPGRADES_TIER_6 = ["byteOfficialV2", "atmosphereOfficialV2", "juggernautOfficialV2"];

		Class.byteOfficialV2.UPGRADES_TIER_8 = ["automationOfficialV2", "kilobyteOfficialV2"];
		...
		Class.juggernautOfficialV2.UPGRADES_TIER_8 = ["jumboOfficialV2", "colossusOfficialV2"];
