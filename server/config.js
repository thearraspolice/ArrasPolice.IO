module.exports = {
  ...
  host: "arraspoliceio-production.up.railway.app",
  ...
  ROOM_SETUP: ["map_apspp_defaultOldDread"],
  ...
  FOOD_SPAWN_CHANCE: 0.006, // Likeliness of normal food spawn attempts succeeding.
  FOOD_SPAWN_COOLDOWN: 650, // Cooldown (in game ticks) of food spawn attempts being made.

  MAZE_FOOD_CAP: 1, // Max normal food per normal tile.
  MAZE_FOOD_SPAWN_CHANCE: 0.01, // Likeliness of normal food spawn attempts succeeding.
  MAZE_FOOD_SPAWN_COOLDOWN: 100, // Cooldown (in game ticks) of food spawn attempts being made.

  FOOD_CAP_NEST: 1, // Max nest food per nest tile.
  FOOD_SPAWN_CHANCE_NEST: 0.1, // Likeliness of nest food spawn attempts succeeding.
  ...
  MODE: "ffa",
  TAG: false,
  USE_OLDDREADNOUGHT_AS_NEST_FOOD: true,
};
