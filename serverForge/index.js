  ...
  switch (true) {
    case instance.label === "Travel Portal" || other.label === "Travel Portal":
      ...
      if (portal.settings.destination && otherBody.isPlayer && otherBody.socket) {
          ...
          if (otherBody.isPlayer && otherBody.skill.level >= 90 || instance.name == "Labyrinth" || instance.name == "2TDM") { // just for safety
            if (d2 > totalRadius * totalRadius) sockets.sendToServer(otherBody.socket, portal.settings.destination, true);
          }
