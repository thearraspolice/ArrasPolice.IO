            ...
            req.on("end", () => {
                ...
                if (json) {
                    if (json.key === process.env.API_KEY) {
                        let { id, name, definition, score, skillcap, skill, points, becomeDednut, checkDednut } = json;
                        sockets.playersReceived.push({ id, name, definition, score, skillcap, skill, points, becomeDednut, checkDednut });
                  //      res.writeHead(200);
                        res.end("OK");
